...
export function Footer() {
    ...
    $btn_theme.addEventListener('click', e => {
        ...
        if (theme === 'dark') {
            document.querySelector('.footer-developedby-img').src = './app/assets/authLogoForDarkMode1.svg'
        }
        else {
            document.querySelector('.footer-developedby-img').src = './app/assets/authLogoForClear.svg'
        }
    })
    ...
    <div class="footer-content">
        ...
        <img src=${actualTheme === 'dark'
            ? './app/assets/authLogoForDarkMode1.svg'
            : './app/assets/authLogoForClear.svg'} alt="Logo-Kristian-Cifuentes-Dev" class="footer-developedby-img" />
        </div>
        ...
        <span class="footer-date"><strong>2024</strong></span>
        </div>
    </div>
    `
